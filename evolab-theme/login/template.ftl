    ...
    <div id="kc-container" class="${properties.kcContainerClass!}">
        <div id="kc-container-wrapper" class="${properties.kcContainerWrapperClass!}">
            ...
            <div id="kc-header" class="${properties.kcHeaderClass!}">
                <div id="kc-header-wrapper" class="${properties.kcHeaderWrapperClass!}" style="color:#fff"><#nested "header"></div>
            </div>

            <div id="kc-content" class="mdc-card ${properties.kcContentClass!}" style="width:50vh;">
            ...
            <#if realm.internationalizationEnabled>
				<div style="color: rgba(255,255,255,0.5);text-align: center;margin-top: 1rem;">
					<div style="font-size: 1rem;">西电AI云端进化实验室</div>
					<div style="font-size: 0.5rem;">端到端的人工智能社会化研发平台</div>
				</div>
